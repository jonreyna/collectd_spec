...
% **************************************************
\newcommand{\thesisTitle}{Collectd Requirements Specification}
\newcommand{\thesisName}{\Large{Jonathan Reyna} \\
...
\newcommand{\thesisSubject}{Application Development}
...
\hypersetup{pdftitle={\thesisTitle},	% 	- title (PDF meta)
